...
// Service icons mapping (all 32 services)
...
// Complete service data - ALL 32 services
const serviceData: Record<string, Service> = {
  'accuracy-verification': {
    ...
    longDescription:
      'Our Accuracy Verification service ensures your data and processes maintain the highest standards of precision. We implement comprehensive quality control systems, automated validation checks, and compliance monitoring to guarantee 99.9% accuracy across all operations.',
  ...
  'ecommerce-solutions': {
    ...
    longDescription:
      'End-to-end ecommerce solutions from platform selection to launch. We build scalable online stores with seamless payment integrations, inventory management, and marketing automation.',
  ...
  'saas-development': {
    ...
    longDescription:
      'We build scalable Software-as-a-Service platforms with subscription management, billing systems, and multi-tenancy architecture. Our solutions are designed to grow with your business.',
  ...
  'account-management': {
    ...
    longDescription:
      'Our Account Management service provides dedicated success managers who work closely with your team to ensure long-term growth, customer retention, and strategic alignment with business goals.',
  ...
  'automated-workflow': {
    ...
    longDescription:
      'Streamline your business processes with our automated workflow solutions. We identify repetitive tasks and implement intelligent automation to save time, reduce errors, and improve efficiency across your organization.',
  ...
  'ai-solutions': {
    ...
    longDescription:
      'Leverage artificial intelligence to transform your business operations. From custom ChatGPT agents to predictive analytics and automation bots, we build AI solutions that drive efficiency, insights, and competitive advantage.',
  ...
  'web-development': {
    ...
    longDescription:
      'We build high-performance web applications using cutting-edge technologies like Next.js, React, and Node.js. From responsive frontends to robust backends, we deliver solutions that scale with your business and provide exceptional user experiences.',
  ...
  'cloud-solutions': {
    ...
    longDescription:
      'Transform your infrastructure with our expert cloud solutions. We design, migrate, and optimize cloud environments for maximum performance, security, and cost-efficiency across AWS, Google Cloud, and Azure platforms.',
  ...
  cybersecurity: {
    ...
    longDescription:
      'Protect your business from cyber threats with our comprehensive security solutions. We implement robust security measures, conduct penetration testing, and ensure compliance with industry standards to safeguard your digital assets.',
  ...
  'data-migration': {
    ...
    longDescription:
      'Seamlessly migrate your data between systems with zero downtime. Our data migration services ensure complete data integrity, validation, and minimal business disruption during the transition process.',
  ...
  'staff-augmentation': {
    ...
    longDescription:
      'Quickly scale your team with our vetted professionals. We provide developers, designers, and project managers who are ready to integrate with your team in 48 hours, bringing expertise and flexibility to your projects.',
  ...
  'data-analysis': {
    ...
    longDescription:
      'Transform your raw data into actionable insights with our data analysis services. We create comprehensive dashboards, establish KPIs, and implement predictive analytics to drive data-informed decision making.',
  ...
  'ui-ux-design': {
    ...
    longDescription:
      'Create exceptional user experiences with our UI/UX design services. We conduct user research, create wireframes and prototypes, and develop design systems that enhance usability and drive engagement.',
  ...
  'devops-cicd': {
    ...
    longDescription:
      'Accelerate your development lifecycle with our DevOps and CI/CD solutions. We implement automated pipelines, infrastructure as code, and monitoring systems to improve deployment frequency and reliability.',
  ...
  'google-workspace': {
    ...
    longDescription:
      'Streamline your collaboration with Google Workspace implementation and management. We handle migration from other platforms, security configuration, and user training for optimal productivity.',
  ...
  'hubspot-crm': {
    ...
    longDescription:
      'Maximize your customer relationships with HubSpot CRM implementation. We set up the platform, create automation workflows, and provide training to help your sales and marketing teams work more effectively.',
  ...
  'administrative-support': {
    ...
    longDescription:
      'Streamline your administrative tasks with our virtual assistance services. We provide scheduling, email management, document preparation, and executive support to help you focus on core business activities.',
  ...
  'business-operations': {
    ...
    longDescription:
      'Optimize your business operations with our process improvement services. We analyze your workflows, identify inefficiencies, and implement solutions to enhance productivity and reduce costs across your organization.',
  ...
  'crm-automation': {
    ...
    longDescription:
      'Automate your customer relationship management processes to improve engagement, increase sales, and enhance customer satisfaction. We create custom automation workflows that work seamlessly with your existing CRM systems.',
  ...
  'compliance-services': {
    ...
    longDescription:
      'Ensure your business meets regulatory requirements with our compliance services. We help you achieve and maintain certifications like GDPR, SOC 2, and ISO, providing peace of mind and building trust with your customers.',
  ...
  'technical-documentation': {
    ...
    longDescription:
      'Create comprehensive technical documentation that helps users understand and use your products effectively. We develop user guides, API documentation, and knowledge bases that improve user experience and reduce support requests.',
  ...
  'email-marketing': {
    ...
    longDescription:
      'Drive engagement and conversions with our email marketing services. We create targeted campaigns, set up automation workflows, and provide analytics to help you build lasting relationships with your audience.',
  ...
  'project-management': {
    ...
    longDescription:
      'Ensure successful project delivery with our professional project management services. We use proven methodologies, risk management techniques, and transparent communication to keep your projects on track and within budget.',
  ...
  'program-management': {
    ...
    longDescription:
      'Coordinate multiple related projects with our program management services. We ensure strategic alignment, optimize resource allocation, and provide executive visibility to maximize the value of your project portfolio.',

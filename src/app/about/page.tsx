          ...
          <div className="text-center mb-4 sm:mb-6 md:mb-8 lg:mb-10 px-3 sm:px-4 md:px-6 lg:px-8">
            ...
            <div className="relative inline-block mx-auto max-w-full">
              <div className="relative overflow-hidden">
                ...
                ></span>
                <span
                  className="relative z-10 text-black font-bold uppercase inline-block text-xs sm:text-sm md:text-base px-3 sm:px-4 md:px-5 lg:px-6 py-1 sm:py-1.5 md:py-2 leading-tight whitespace-nowrap"
                  style={{
                    fontFamily: '"Bebas Neue", Arial, sans-serif',
